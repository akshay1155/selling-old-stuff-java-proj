...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title> selling your old stuff</title>
  ...
  <body>
    <div class="header">
      <div class="container">
        <div class="navbar">
          <div class="logo">
            <a href="index.jsp"><img src="images/newlogo.png" width="235px" />
              </a>
          </div>
          <nav>
            <ul id="MenuItems">
        ...
        <div class="row">
          <div class="col-2">
            <h1>BUY,SELL AND <br />FIND JUST ABOUT ANYTHING</h1>
            <p>
...
<div class="categories-prod" style="grid-column: auto/span 4;">
      <div class="small-container">
        <div >
            <a href="product-detail.jsp?sid=<%=rs.getString("sid")%> "><img src="images2/<%=imgFileName%>" style="width:340px;height:250px"></a>
